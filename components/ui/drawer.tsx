...
const DrawerContext = React.createContext<{ direction?: "left" | "bottom" | "right" | "top" }>({});
      ...
      <DrawerPortal>
        ...
        <DrawerPrimitive.Content
          ...
          className={cn(
            ...
            direction === "right" && "top-0 right-0 w-screen max-w-64 sm:max-w-96 h-full",
            direction === "left" && "top-0 left-0 w-screen max-w-64 sm:max-w-96 h-full",
            className
          )}
          {...props}
        >
