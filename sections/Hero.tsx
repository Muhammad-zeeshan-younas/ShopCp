...
const Hero = () => {
  ...
  return (
    <section className="relative w-full overflow-hidden">
      ...
      <div className="container relative grid grid-cols-1 gap-12 py-16 md:grid-cols-2 md:py-24">
        {/* Content Column */}
        <div className="flex flex-col justify-center space-y-8">
          ...
          >
            {/* Badge with icon */}
            <div className="inline-flex items-center gap-2 rounded-full bg-primary/10 py-1.5 text-sm font-medium text-primary">
            ...
            <div className="flex flex-wrap gap-4 pt-4">
              <Button
                size="lg"
                className="group rounded-full px-8 py-6 text-lg font-semibold shadow-lg transition-all hover:shadow-primary/20"
              >
                <span>Shop Now</span>
          ...
          >
            {[
              ...
              >
                <Card className="border-none bg-background/50 p-4 shadow-sm backdrop-blur-sm transition-all group-hover:bg-background/30 dark:group-hover:bg-accent/80 group-hover:shadow-md">
